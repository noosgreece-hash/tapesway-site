...
const ANGLES: Angle[] = [
  {
    ...
    onScreen: { EN: "Mornings on {island}", DE: "Morgens auf {island}", IT: "Le mattine a {island}", FR: "Le matin à {island}", EL: "{island}, πρωί" },
    ...
    caption: {
      ...
      IT: "Da {name} la giornata inizia piano. Un caffè, la luce sul mare e nessuna fretta. {island}, di prima mattina.",
  ...
  },
  {
    ...
    onScreen: { EN: "Before you arrive", DE: "Bevor Sie ankommen", IT: "Prima del vostro arrivo", FR: "Avant votre arrivée", EL: "Πριν φτάσετε" },
    ...
    caption: {
      ...
      IT: "Quello che non si vede prima dell'arrivo degli ospiti: la cura per ogni dettaglio da {name}.",
  ...
  },
  {
    ...
    onScreen: { EN: "Our local tip", DE: "Unser Geheimtipp", IT: "Il nostro consiglio", FR: "Notre bon plan", EL: "Η δική μας πρόταση" },
    ...
    caption: {
      ...
      IT: "Il nostro angolo preferito di {island}, quello che consigliamo a ogni ospite. Salvalo per il tuo viaggio.",
  ...
  },
  {
    ...
    onScreen: { EN: "The little things", DE: "Die kleinen Dinge", IT: "Le piccole cose", FR: "Les petits détails", EL: "Οι μικρές λεπτομέρειες" },
    ...
    caption: {
      ...
      IT: "Sono le piccole cose di cui gli ospiti parlano quando ripartono. Questa è una delle nostre, da {name}.",
  ...
  },
  {
    ...
    onScreen: { EN: "Golden hour", DE: "Goldene Stunde", IT: "L'ora d'oro", FR: "L'heure dorée", EL: "Χρυσή ώρα" },
    ...
    caption: {
      ...
      IT: "Quando la luce su {island} diventa dorata, tutto rallenta. Le serate da {name}.",
  ...
  },
  {
    ...
    onScreen: { EN: "One day, 20 seconds", DE: "Ein Tag, 20 Sekunden", IT: "Un giorno in 20 secondi", FR: "Une journée, 20 secondes", EL: "Μία μέρα, 20 δευτερόλεπτα" },
    ...
    caption: {
      ...
      IT: "Dal primo caffè all'ultima luce: un'intera giornata da {name}, in venti secondi.",
