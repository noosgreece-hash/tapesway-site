    ...
    items: [
      ...
      },
      {
        ...
        text: [
          ...
          "Δημιουργούμε περιεχόμενο με φυσική και καθαρή επικοινωνία στα **αγγλικά, γερμανικά, ιταλικά και γαλλικά**, προσαρμοσμένο στο κοινό που θέλετε να προσεγγίσετε."
        ]
      },
      {
